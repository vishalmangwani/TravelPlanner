...
#content form input[type="submit"],[type="reset"] {
...
#content form input[type="submit"],[type="reset"]:hover {
...
<div id="templatemo_container">
	...
	<div id="templatemo_header">
  	...
  	<ul>
  	  <li><a href="view.jsp">All Users</a></li>
                 	 <li><a href="delete.jsp"  class="current">Delete Users</a></li>
...
<thead>
<tr><th><td><b>FirstName</td><td><b>LastName</td><td><b>Emailid</td><tr>
</thead>
<%while(rs.next())
	{
	%>
<tr >
<td><input type=checkbox value=<%=rs.getString(8) %> name=deleteoption></td>
...
<input type=submit value="Delete"></center></form>
        	  		...
        	  		<div id="footer">
     <center> <c><a href ="http://localhost:8081/finalone/opener.jsp">Main Page</a>&nbsp;&nbsp;&nbsp;&nbsp;</c>
      <a href ="http://localhost:8081/finalone/loginwala.jsp">Admin Login</a>&nbsp;&nbsp;&nbsp;&nbsp;
      <a href ="http://localhost:8081/finalone/hsclogin.jsp">HSC Login</a>&nbsp;&nbsp;&nbsp;&nbsp;</center>
           </div>
